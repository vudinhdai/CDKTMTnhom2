 ...
 <div class="container">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav m-auto">
      ...
      <input required class="form-control " type="search" name="search" placeholder="Tìm kiếm..." aria-label="Search"
       action style="background-color: #ff9600; border:2px solid white; width: 400px;">
      <button class="btn btn-dark" type="submit"><b>Tìm kiếm</b></button>
    </form>
    </ul>
    <a href="{{asset('cart')}}"><h4 style="color: white;"><b>GIỎ HÀNG</b></h4></a>
  </div>
  </div>
</nav>
	<!-- endheader -->
	...
	<div class="container">
		<div id="wrap-inner">
						<div class="products">
							<h3 style="" >sản phẩm khuyến mãi</h3>
