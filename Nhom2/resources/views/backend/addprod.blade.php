							...
							<div class="row" style="margin-bottom:40px">
								<div class="col-xs-8">
									...
									<div class="form-group" >
										...
										<input  type="number" name="promotion" placeholder="Có thể để trống" class="form-control">
									</div>
									<div class="form-group" >
									...
									<div class="form-group" >
										<label>Miêu tả</label>
										<textarea cols="50" rows="7" required name="description"></textarea>
									</div>
									<div class="form-group" >
