			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav m-auto">
					<form class=" form-inline my-2 my-lg-0" method="get" action="{{asset('search/')}}">
						<input required class="form-control " type="text" name="search" placeholder="Tìm kiếm..." aria-label="Search" action style="background-color: #ff9600; border:2px solid white; width: 400px;">
